...
R にも流行があります。この本では長年変わらぬ部分だけが紹介されているので安心感があります。少しマニアックな内容がふんだんに盛り込まれていますが，よく分からない部分にこだわらずにどんどん進みましょう。
...
```{r hist, prompt=TRUE, cache=FALSE, out.width=300}
m = 35
s = 2
